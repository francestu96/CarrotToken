...
contract ApeSkulls {
    ...
    uint256 private SKULLS_MARKET_INIT = 108000000000;
    uint256 private SKULLS_TO_COLLECT_1MINERS = 1080000;
    ...
    function hatchSkulls(address ref) public {
        require(initialized);
        ...
        claimedSkulls[referrals[msg.sender]] = claimedSkulls[referrals[msg.sender]] + skullsUsed / 8;
